...
export class LoginComponentsComponent implements OnInit {
  ...
  constructor(private httpservice: HttpcallsService, private router: Router,private userservice:CommonService) {}
  ngOnInit(): void {
  ...
  onsubmit() {
    ...
    this.httpservice
      ...
      .subscribe((e: any) => {
        this.success = true;
        this.userservice.setuserName(e.userName);
        this.userservice.setUserId(e.userId);
